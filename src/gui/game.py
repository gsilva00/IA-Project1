...
def play(screen):
    ...
    while True:
        ...
        grid_offset_x = (SCREEN_WIDTH - board_width) // 2
        ...
        while running:
            ...
            if game_over:
                ...
                draw_board(screen, board, grid_offset_y, grid_offset_x)
                ...
                if selected_shape is not None:
                    draw_shape(screen, selected_shape, (px, py), True, grid_offset_y)
                ...
                for event in pygame.event.get():
                    ...
                    if event.type == pygame.MOUSEBUTTONUP:
                        if selected_shape is not None:
                            if is_valid_position(board, selected_shape, (px-4, py)):
                                place_piece(board, selected_shape, (px-4, py))
